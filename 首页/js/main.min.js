...
default = function() {
	...
	var u = "js-fullscreen-wrap",
		...
		f = "js-fullscreen-bg",
		l = ["rgb(215,95,61)", "#7bc8bc", "#868eaf", "#ec6867", "#f8bb0e"],
		h = function() {
			function t(n, e) {
				!
				function(t, n) {
					if (!(t instanceof n)) throw new TypeError("Cannot call a class as a function")
				}(this, t), this.elmWrap = n.querySelector(".".concat(u)), this.elmSection = n.querySelectorAll(".".concat(s)), this.elmPager = n.querySelector(".".concat(c)), this.elmPagerPointers = n.querySelectorAll(".".concat(a)), this.elmBg = n.querySelector(".".concat(f)),

                    this.currentId = 0, this.previousId = 0, this.maxId = this.elmSection.length - 1, this.isAscend = !0, this.wheelTimer = null, this.isWheeling = !1, this.touchStartY = 0, this.isTouchMoved = !1, this.resize(e)
			}
			var n, e, r;
			return n = t, (e = [{
				key: "start",
